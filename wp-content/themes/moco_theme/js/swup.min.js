!(function (t, e) {
  ...
  const n = (t, e) =>
    ...
    i = (t, n, o, r) => {
      ...
      return (
        (function (t, n, o, r = {}) {
          const { signal: i, base: s = document } = r;
          if (i?.aborted) return;
          const { once: a, ...c } = r,
            l = s instanceof Document ? s.documentElement : s,
            u = Boolean("object" == typeof r ? r.capture : r),
            h = (r) => {
              ...
              if (i) {
                const t = Object.assign(r, { delegateTarget: i });
                o.call(l, t),
                  a && (l.removeEventListener(n, h, c), e(!1, l, o, d));
              }
            },
            d = JSON.stringify({ selector: t, type: n, capture: u });
          e(!0, l, o, d) || l.addEventListener(n, h, c),
            i?.addEventListener("abort", () => {
              e(!1, l, o, d);
            });
        })(t, n, o, (r = { ...r, signal: i.signal })),
        { destroy: () => i.abort() }
      );
    };
  class s extends URL {
  ...
  const a = function (t, e) {
    ...
    try {
      const o = this;
      function n(n) {
        const { status: i, url: a } = h;
        return Promise.resolve(h.text()).then(function (n) {
          if (500 === i)
            throw (
              (o.hooks.call("fetch:error", r, {
                status: i,
                response: h,
                url: a,
              }),
              new c(`Server error: ${a}`, { status: i, url: a }))
            );
          if (!n) throw new c(`Empty response: ${a}`, { status: i, url: a });
      ...
      t = s.fromUrl(t).url;
      const { visit: r = o.visit } = e,
        i = { ...o.options.requestHeaders, ...e.headers },
        a = e.timeout ?? o.options.timeout,
        l = new AbortController(),
        { signal: u } = l;
      e = { ...e, headers: i, signal: u };
      let h,
        d = !1,
        f = null;
      a &&
      ...
      const m = (function (n, i) {
        try {
          var s = Promise.resolve(
            o.hooks.call("fetch:request", r, { url: t, options: e }, (t, e) => {
        ...
        if (d)
          throw (
            (o.hooks.call("fetch:timeout", r, { url: t }),
            new c(`Request timed out: ${t}`, { url: t, timedOut: d }))
          );
        if ("AbortError" === e?.name || u.aborted)
  ...
  class m {
    ...
    get targets() {
      return this.selector.trim() ? h(this.selector) : [];
    }
    add() {
  ...
  function w(t, e, n) {
    if (!t.s) {
      if (n instanceof y) {
        if (!n.s) return void (n.o = w.bind(null, t, e));
        1 & e && (e = n.s), (n = n.v);
      }
      if (n && n.then)
        return void n.then(w.bind(null, t, e), w.bind(null, t, 2));
      (t.s = e), (t.v = n);
      const o = t.o;
      o && o(t);
    }
      ...
      (t.prototype.then = function (e, n) {
        ...
        return (
          (this.o = function (t) {
            try {
              const r = t.v;
              1 & t.s ? w(o, 1, e ? e(r) : r) : n ? w(o, 1, n(r)) : w(o, 2, r);
            } catch (t) {
              w(o, 2, t);
            }
          }),
  ...
  class k {
    ...
    call(t, e, n, o) {
      try {
        const r = this,
          ...
          { before: c, handler: l, after: u } = r.getHandlers(t, a);
    ...
    callSync(t, e, n, o) {
      ...
      this.runSync(a, r, i);
      const [u] = this.runSync(c, r, i, !0);
      return this.runSync(l, r, i), this.dispatchDomEvent(t, r, i), u;
    }
    parseCallArgs(t, e, n, o) {
      return e instanceof p || ("object" != typeof e && "function" != typeof n)
        ? [e, n, o]
        : [void 0, e, n];
    }
    run(t, e, n, o) {
      ...
      try {
        ...
        const s = [],
          a = (function (t, e, n) {
            ...
            t,
            function (t) {
              let { hook: r, handler: a, defaultHandler: c, once: l } = t;
              if (!e?.done)
                return (
                  l && i.off(r, a),
                  (function (t, o) {
    ...
    runSync(t, e, n, o) {
      ...
      const r = [];
      for (const { hook: i, handler: s, defaultHandler: a, once: c } of t)
        if (!e?.done) {
          c && this.off(i, s);
          try {
            const t = s(e, n, a);
            r.push(t),
              f(t) &&
                console.warn(
                  `Swup will not await Promises in handler for synchronous hook '${i}'.`
                );
          } catch (t) {
            if (o) throw t;
    ...
    getHandlers(t, e) {
      ...
      return { found: !0, before: i, handler: l, after: a, replaced: c };
    }
  ...
  const b = (t) => {
      ...
      let n =
        ...
        u(`a[name='${CSS.escape(t)}']`) ||
        u(`a[name='${CSS.escape(e)}']`);
    ...
    S = function (t) {
      ...
      try {
        ...
        let t = [];
        if (e) t = Array.from(e);
        else if (n && ((t = h(n, document.body)), !t.length))
          return (
            console.warn(
              `[swup] No elements found matching animationSelector \`${n}\``
            ),
            Promise.resolve()
          );
        const o = t.map((t) =>
          (function (t) {
            const {
              ...
              return {
                type: l,
                timeout: c,
                propCount: l ? (l === E ? o.length : s.length) : 0,
              };
            })(t);
            return (
              !(!e || !n) &&
                ...
                const c = () => {
                  ...
                  l = (e) => {
                    if (e.target === t) {
                      if (
                        !(function (t) {
                          return [`${E}end`, `${U}end`].includes(t.type);
                        })(e)
                      )
        ...
        return o.filter(Boolean).length > 0
          ...
          : (n &&
              console.warn(
                `[swup] No CSS animation duration defined on elements matching \`${n}\``
              ),
            Promise.resolve());
      } catch (t) {
        return Promise.reject(t);
  ...
  const A = function (t, e) {
    ...
    try {
      ...
      function i(i) {
        if (s) return i;
        (a.navigating = !0), (a.visit = t);
        const { el: c } = t.trigger;
        (e.referrer = e.referrer || a.currentPageUrl),
          !1 === e.animate && (t.animation.animate = !1),
          t.animation.animate || a.classes.clear();
        const l = e.history || c?.getAttribute("data-swup-history") || void 0;
        l && ["push", "replace"].includes(l) && (t.history.action = l);
        const u =
          e.animation || c?.getAttribute("data-swup-animation") || void 0;
        return (
          u && (t.animation.name = u),
          ...
          (function (i, s) {
              ...
              var c = (function (i, s) {
                try {
                  var c = Promise.resolve(
                    a.hooks.call("visit:start", t, void 0)
                  ).then(function () {
                    function i() {
                      if (!t.done)
                        return Promise.resolve(
                              ...
                              try {
                                ...
                                function e(e) {
                                  return n
                                    ? e
                                    : (t.advance(4),
                                      Promise.resolve(a.animatePageOut(t)).then(
                                        function () {
                                          function e() {
                                            return Promise.resolve(
                                              a.animatePageIn(t)
                                ...
                                const o = (function () {
                                  if (!t.animation.animate)
                                    return Promise.resolve(
                                      a.hooks.call("animation:skip", void 0)
                                    ).then(function () {
                                      const e = a.renderPage;
                                      return Promise.resolve(s).then(function (
                                        o
                                      ) {
                                        return Promise.resolve(
                                          e.call(a, t, o)
                          ...
                          if (!t.done)
                            return Promise.resolve(
                              a.hooks.call("visit:end", t, void 0, () =>
                                a.classes.clear()
                              )
                            ).then(function () {
                              (t.state = 7),
                                (a.navigating = !1),
                                a.onVisitEnd &&
                                  (a.onVisitEnd(), (a.onVisitEnd = void 0));
                            });
                        });
                    }
                    t.state = 3;
                    const s = a.hooks.call(
                      "page:load",
                      t,
                      { options: e },
                      function (t, e) {
                        try {
                          ...
                          let o;
                          return (
                            t.cache.read && (o = a.cache.get(t.to.url)),
                            Promise.resolve(
                              o
                                ? n(o)
                                : Promise.resolve(
                                    a.fetchPage(t.to.url, e.options)
                                  ).then(n)
                            )
                          );
                        } catch (r) {
                    ...
                    if (
                      ...
                      t.to.url === a.currentPageUrl
                        ...
                        : (a.currentHistoryIndex++,
                          ...
                          })(e, { index: a.currentHistoryIndex }));
                    }
                    (a.currentPageUrl = o()),
                      t.history.popstate && a.classes.add("is-popstate"),
                      t.animation.name &&
                        a.classes.add(`to-${n(t.animation.name)}`);
                    const c = (function () {
                      if (t.animation.wait)
                        return Promise.resolve(s).then(function () {});
                    })();
                ...
                e && !e?.aborted
                  ? ((t.state = 9),
                    console.error(e),
                    (a.options.skipPopStateHandling = () => (
            ...
            return c && c.then
              ? c.then(s.bind(null, !1), s.bind(null, !0))
              : s(!1, c);
          })(0, function (e, n) {
      ...
      const c = (function () {
        if (a.navigating)
          return (function () {
            if (!(a.visit.state >= 6))
              return Promise.resolve(
                a.hooks.call("visit:abort", a.visit, void 0)
              ).then(function () {
                delete a.visit.to.document, (a.visit.state = 8);
              });
            (t.state = 2),
              (a.onVisitEnd = () => a.performNavigation(t, e)),
              (s = 1);
          })();
      })();
      return Promise.resolve(c && c.then ? c.then(i) : i(c));
    } catch (l) {
  ...
  function H(t, e, n) {
    ...
    const { url: o, hash: r } = s.fromUrl(t),
      i = this.createVisit({ ...n, to: o, hash: r });
  ...
  const T = function (t) {
    ...
    j = function (t) {
      ...
      document.title = n;
      const o = h('[data-swup-persist]:not([data-swup-persist=""])'),
        r = t.containers
          .map((t) => {
    ...
    L = function (t) {
      ...
      return (
        ...
        o &&
          !i &&
          (i = this.hooks.callSync("scroll:top", t, { options: e }, (t, e) => {
            let { options: n } = e;
    ...
    I = function (t, e) {
      try {
        ...
        const { url: s } = e;
        return (
          i.isSameResolvedUrl(o(), s) ||
            (r(s), (i.currentPageUrl = o()), (t.to.url = i.currentPageUrl)),
          Promise.resolve(
            i.hooks.call("content:replace", t, { page: e }, (t, e) => {
              if (
                (i.classes.remove("is-leaving"),
                t.animation.animate && i.classes.add("is-rendering"),
                !i.replaceContent(t))
              )
                throw new Error("[swup] Container mismatch, aborting");
              t.animation.animate &&
                (i.classes.add("is-changing", "is-animating", "is-rendering"),
                t.animation.name && i.classes.add(`to-${n(t.animation.name)}`));
            })
          ).then(function () {
            return Promise.resolve(
              i.hooks.call("content:scroll", t, void 0, () =>
                i.scrollToContent(t)
              )
            ).then(function () {
              return Promise.resolve(
                i.hooks.call("page:view", t, {
                  url: i.currentPageUrl,
  ...
  return class {
    constructor(t) {
      void 0 === t && (t = {}),
        ...
        (this.fetchPage = a),
        (this.awaitAnimations = S),
        (this.renderPage = I),
        (this.replaceContent = j),
        (this.animatePageIn = V),
        ...
        (this.classes = new m(this)),
        (this.hooks = new k(this)),
      ...
      try {
        ...
        return (
          ...
          "swup" !== window.history.state?.source &&
            r(null, { index: t.currentHistoryIndex }),
    ...
    shouldIgnoreVisit(t, e) {
      ...
      const { origin: r, url: i, hash: a } = s.fromUrl(t);
      return (
        r !== window.location.origin ||
        !(!n || !this.triggerWillOpenNewWindow(n)) ||
        !!this.options.ignoreVisit(i + a, { el: n, event: o })
      );
    }
    handleLinkClick(t) {
      const e = t.delegateTarget,
        { href: n, url: o, hash: i } = s.fromElement(e);
      if (this.shouldIgnoreVisit(n, { el: e, event: t })) return;
      if (this.navigating && o === this.visit.to.url)
        return void t.preventDefault();
      const a = this.createVisit({ to: o, hash: i, el: e, event: t });
          ...
          this.hooks.callSync("link:click", a, { el: e, event: t }, () => {
            ...
            t.preventDefault(),
              o && o !== e
                ...
                : i
                ? this.hooks.callSync("link:anchor", a, { hash: i }, () => {
                    r(o + i), this.scrollToContent(a);
                  })
                : this.hooks.callSync("link:self", a, void 0, () => {
                    "navigate" === this.options.linkToSelf
                      ? this.performNavigation(a)
                      : (r(o), this.scrollToContent(a));
                  });
          });
    }
    handlePopState(t) {
      ...
      const { url: n, hash: r } = s.fromUrl(e),
        i = this.createVisit({ to: n, hash: r, event: t });
      ...
      a &&
        ...
        (i.animation.animate = !1),
        (i.scroll.reset = !1),
        (i.scroll.target = !1),
        this.options.animateHistoryBrowsing &&
          ((i.animation.animate = !0), (i.scroll.reset = !0)),
        this.hooks.callSync("history:popstate", i, { event: t }, () => {
