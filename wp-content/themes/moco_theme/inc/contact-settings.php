...
class Page extends Settings {
    ...
    public function __construct() {
        $this->id = 'contact_settings';
        $this->page_title = __('Communication Settings');
        $this->menu_title = __('Communication Settings');
    ...
    protected function define_fields() {
        $this->fields['contact_1'] = [
            'name' => 'contact_1',
            'title' => __('Communication Settings'),
            'description' => __(''),
            'type' => 'section'
        ];
        ...
        $this->fields['contact_adress_1'] = [
            'name' => 'contact_adress_1',
            'title' =>  __('Adress'),
            'type' => 'text',
            'section' => 'contact_1'
        ];

        $this->fields['contact_phone_1'] = [
